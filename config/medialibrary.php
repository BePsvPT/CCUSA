...
return [
     ...
     */
    'defaultFilesystem' => 'media.default',
     ...
     * dependency.
     */
    'ffmpeg_binaries' => 'Darwin' === PHP_OS ? '/usr/local/bin/ffmpeg' : '/usr/bin/ffmpeg',
    'ffprobe_binaries' => 'Darwin' === PHP_OS ? '/usr/local/bin/ffprobe' : '/usr/bin/ffprobe',
